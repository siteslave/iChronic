((window, angular) => {
   ...
   angular.module('app.services.Report', [])
    .factory('ReportService', ($q, ConfigService) => {
        ...
        return {
            ...
            getCvd(start, end, hns) {
                let q = $q.defer();
                db('opdscreen as o1')
                .select('v.village_code', 'o1.hn', 'o1.vstdate', 'o1.bps as sbp', 'o1.bw as weight', 'o1.waist',
                    'o1.height', 'o1.tc', 'o1.hdl', 'o1.ldl',
                    db.raw('if(sm.nhso_code is null, 1, sm.nhso_code) as smoking'), db.raw('if(dm.nhso_code is null, 1, dm.nhso_code) as drinking'),
            ...
            getCkd(start, end, hns) {
                ...
                db('opdscreen as o1')
                .select('v.village_code', 'o1.hn', 'o1.vstdate',
                    db.raw(`
                 case
